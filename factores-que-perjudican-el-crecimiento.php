    ...
    <main class="main-container">
        ...
        <div class="text-container">
            ...
            <ul>
                ...
                <li>Deficiencias hormonales.</li>
                <li>Padecimientos y afecciones médicas crónicas.</li>
                <li>Afecciones genéticas.</li>
                <li>Medicamentos.</li>
            </ul>
            <div class="contenedor-video ">
                <div class="reproductor" data-id="BXOOo5c3LGM"></div>
            </div>
            <p>Así mismo algunos de los niños que tienen baja estatura que no está relacionada con alguna afección médica también pueden querer alcanzar una mayor estatura para sobresalir física y socialmente</p>
            <ul>
                <li><strong>Baja estatura en la familia</strong></li>
                <li><strong>Baja estatura idiopática</strong> (sin causa identificable).</li>
