...
<section id="site-wrapper">
    ...
    <section id="site-canvas">
        ...
        <div class="contenedor-principal" id="contenedor-principal">
            ...
            <div class="contenedor-85porciento ">
                <div class="justificar-texto-90-listas">
                    <ul>
                       ...
                       <li>Proporciones corporales normales. </li>
                       <li>Sin evidencia de enfermedad orgánica crónica. </li>
                       <li>Sin enfermedad psiquiátrica o alteración emocional grave.</li>
                       <li>Nutrición adecuada.</li>
                       <li>Sin evidencia de déficit endocrino. </li>
                    </ul>
                </div>
            </div>
            <div class="justificar-texto-85 ">
            ...
            <div class="contenedor-85porciento ">
                <div class="justificar-texto-90-listas">
                    <ul>
                        ...
                        <li>Velocidad de crecimiento normal (>percentil 25).</li>
                        <li>Pubertad normal.</li>
                        <li>Edad ósea normal (diferencia máxima de 1 año con la edad cronológica).</li>
                        <li>Pronóstico de talla adulta semejante a la talla diana.</li>
                        <li>Talla final baja.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="contenedor-85porciento ">
                <div class="justificar-texto-90-listas">
                    <ol>
                        ...
                        <li>Longitud y peso al nacimiento normales para la edad gestacional </li>
                        <li>Proporciones corporales normales sin evidencias de alteraciones esqueléticas </li>
                        <li>Ausencia de anomalías fenotípicas y rasgos dismórficos que sugieran cromosomopatías </li>
                        <li>Funciones gastrointestinal, hepática, cardíaca, pulmonar y renal normales </li>
                        <li>Ausencia de problemas nutricionales </li>
                        <li>Ausencia de trastornos psico-afectivos graves </li>
                        <li>Ausencia de alteraciones metabólicas </li>
                        <li>Función endocrinológica normal incluyendo la secreción de GH </li>
                        <li>Exclusión de los casos sospechosos de RCCD </li>
                        <li>Exclusión del síndrome de Turner en las niñas </li>
                        <li>Exclusión del síndrome de Noonan </li>
                        <li>Exclusión de mutaciones en el gen SHOX </li>
                        <li>Exclusión de mutaciones en genes relacionados con el mecanismo de acción periférica de la GH (receptor de GH, vías de señalización intracelular, IGF-I, receptor IGF-I, ALS) </li>
                    </ol>
                </div>
            </div>
            <div class="justificar-texto-85 pb-15">
            ...
            <div class="tamaño-img">
                <a href="/padecimentos-que-afectan-el-crecimiento/retraso-constitucional-del-crecimiento-y-la-pubertad/"><img src="/img/causas-de-la-baja-estatura/Banner-Retraso-constitucional-del-crecimiento-y-la-pubertad-.webp" alt="banner que enlaza a retraso constitucional del crecimiento"></a>
            </div>
