    ...
    <section id="site-canvas">
        ...
        <div class="contenedor-principal" id="contenedor-principal">
            ...
            <article class="article-container"> 
                <h2>“Las tasas de crecimiento</span> dependen de la edad de los niños”</h2>
            </article>
            
            <div class="justificar-texto-90">
                <p>Existe una guía conocida como la <b> "regla de los cinco"</b> que describe la tasa de crecimiento típica de un niño. Esta sugiere:</p>
            </div>
            <div class="contenedor-principal margin-negativo-top-35">
                <div class="justificar-texto-90-listas">
                    <ul>
                        <li><b> Desde el nacimiento hasta el 1 año, los bebés crecen unos 25 cm.</b></li>
                        <li><b> De 1 a 4 años de edad, los niños crecen a un ritmo de unos 10 cm por año.</b></li>
                        <li><b> Desde los 4 años hasta la pubertad, su crecimiento se ralentiza a unos 5 cm por año.</b></li>
                    </ul>
                </div>
            </div>
            <div class="justificar-texto-90">
                <p><b> Se estima que alrededor del 80% del crecimiento de un niño ocurrirá antes de la pubertad</b> y durante la pubertad hay un período rápido de crecimiento, llamado estirón puberal, que es cuando finalmente se debe
            ...
            <div class="cuadros-crecimiento-crecimiento margin-negativo-2">
                ...
                <div class="centrar-texto texto-boton-esp-2 pb-2">
                    <a href="/crecimiento-infantil-por-edad/cambios-en-la-adolescencia"><button class="boton-e-2 boton-crecimiento-2">Cambios en la adolescencia</button></a>
                </div>   
                <div class="img-95 padding-1">
                    <img width="800" height="422" loading="lazy" src="/img/crecimiento-infantil-por-edad/crecimiento-en-adolescentes-de-12-a-17.webp" alt="Crecimiento en adolescentes de 12 a 17 años de edad.">
                </div>
                ...
                <div class="centrar-texto texto-boton-esp-2 pb-2 margin-top-20">
                    <a href="/crecimiento-infantil-por-edad/adolescentes-12-16"><button class="boton-e-2 boton-crecimiento-2">Aprende más</button></a>
                </div>    
            </div>    
            ...
            <div class="cuadros-crecimiento-crecimiento margin-negativo-2">
                ...
                <div class="img-95 padding-1">
                    <img width="800" height="422" loading="lazy" src="/img/crecimiento-infantil-por-edad/crecimiento-en-ninos-de-6-a-11.webp" alt="Crecimiento en niños de 6 a 11 años de edad.">
                </div>
                <div class="texto-importancia-2">
            ...
            <div class="cuadros-crecimiento-crecimiento margin-negativo-2">
                ...
                <div class="img-95 padding-1">
                    <img width="800" height="422" loading="lazy" src="/img/crecimiento-infantil-por-edad/crecimiento-en-ninos-de-2-a-5.webp" alt="Crecimiento en niños pequeños de 2 a 5 años de edad.">
                </div>    
                <div class="texto-importancia-2">
                ...
                <div class="centrar-texto texto-boton-esp-2 pb-2 margin-top-20">
                    <a href="/crecimiento-infantil-por-edad/ninos-chicos-2-5"><button class="boton-e-2 boton-crecimiento-2">Aprende más</button></a>
                </div>    
            </div>    
            ...
            <div class="cuadros-crecimiento-crecimiento margin-negativo-2">
                ...
                <div class="img-95 padding-1">
                    <img width="800" height="422" loading="lazy" src="/img/crecimiento-infantil-por-edad/crecimiento-en-bebes-de-0-a-2.webp" alt="Crecimiento en bebes de 0 a 2 años de edad.">
                </div>    
                <div class="texto-importancia-2">
                ...
                <div class="centrar-texto texto-boton-esp-2 pb-2 margin-top-20">
                    <a href="/crecimiento-infantil-por-edad/bebes-0-2"><button class="boton-e-2 boton-crecimiento-2">Aprende más</button></a>
                </div>    
            </div>    

            <div class="textos-principal margin-negativo">
                <p><b> Te invitamos a que agendes una cita</b> para que uno de nuestros médicos endocrinólogo pediatra especialista en crecimiento pueda hacer un diagnóstico personalizado de tu hijo y diseñar el tratamiento adecuado
            ...
            <a href="/preguntas-frecuentes">
                    <picture>
                        ...
                        <img  class="tamaño-img" src="/img/banners/banner-preguntas-frecuentes-c.webp" alt="Banner preguntas frecuentes sobre el crecimiento infantil en niños.">
                    </picture>
            </a>
