    ...
    <section id="site-canvas">
        ...
        <div class="contenedor-principal" id="contenedor-principal">
            ...
            <div class="tamaño-img pt-1p">
                <img src="/img/causas-baja/direncia-entre-talla-baja-y-el-retraso-constitucional.webp" alt="diferencias entre la talla baja familiar y el retraso constitucional">
            </div>
