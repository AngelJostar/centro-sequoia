...
<meta name="description" content="Página de contacto por instagram">
<title>landing instagram</title>
        ...
        <section class="contenedor-principal" id="contenedor-principal">
            <div class="cuadros-crecimiento">
                <div class="titulos-grid-index">
                    ...
                    <h1><span class="font-bold">BIENVENIDO</span> <br> CONOCE MÁS SOBRE SEQUOIA</h1>
                    <div class="flexbox padre">
                        <div class="barra-titulo"></div>
                    </div>
                </div>
