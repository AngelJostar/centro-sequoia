...
<meta name="description" content="Centro SEQUOIA es un Centro Pediátrico Exclusivo para el Crecimiento de los niños  Nutricion - Equivalencia en Leche">
<title>Nutrición - Tablas de equivalencias en leche</title>
        ...
        <div class="contenedor-principal" id="contenedor-principal">
            <div class="cuadros-crecimiento">
                <div class="titulos-grid-baja-estatura">
                    ...
                    <h1><span class="font-bold">LECHE</span></h1>
                    <div class="flexbox padre">
                        <div class="barra-titulo"></div>
                    </div>
                </div>
            ...
            <div class="justificar-texto-90 centrar-texto">
                ...
                <div>
                    <div>
                        <div class="linea-horizontal-tablas mt-1"></div>
                        <p class="tablas-letras-titulo">SEMIDESCREMADA</p>
                        <div class="linea-horizontal-tablas mb-1"></div>
                    </div>
                    <div class="tablas-grid-2">
                        <div class="tablas-letras">
                            <p>Jocoque 5 cdas</p>
                            <p>Leche Semidescremada 1tza</p>
                        </div>
                        <div class="linea-vertical-tablas"></div>
                        <div class="tablas-letras">
                            <p>Helado de Yogurt 1/2 tza</p>
                            <p>Yogurt Natural Semidescremado 1tza</p>
                        </div>
                    </div>
                </div>
                <div>
                    <div>
                        <div class="linea-horizontal-tablas mt-1"></div>
                        <p class="tablas-letras-titulo">LECHE ENTERA</p>
                        <div class="linea-horizontal-tablas mb-1"></div>
                    </div>
                    <div class="tablas-grid-2">
                        <div class="tablas-letras">
                        ...
                        <div class="linea-vertical-tablas"></div>
                        <div class="tablas-letras">
                            <p>Leche evaporada entera 1/2 tza</p>
                            <p>Yogurt natural 3/4 tza</p>
                        </div>
                    </div>
                </div>
                <div>
                    <div>
                        <div class="linea-horizontal-tablas mt-1"></div>
                        <p class="tablas-letras-titulo">CON AZÚCAR</p>
                        <div class="linea-horizontal-tablas mb-1"></div>
                    </div>
                    <div class="tablas-grid-2">
                        <div class="tablas-letras">
                        ...
                        <div class="tablas-letras">
                            <p>Helado 2 bolas</p>
                            <p>Yogurt de frutas 3/4 de tza</p>
                        </div>
                    </div>
                </div>
                <div class="mt-1">
