...
<meta name="description" content="Centro SEQUOIA�0�2es un�0�2Centro Pedi��trico Exclusivo para el Crecimiento de los ni�0�9os�0�2 Nutricion - Equivalencia en Leguminosas">
<title>Nutrición - Tablas de equivalencias de leguminosas</title>
        ...
        <div class="contenedor-principal" id="contenedor-principal">
            <div class="cuadros-crecimiento">
                <div class="titulos-grid-baja-estatura">
                    ...
                    <h1><span class="font-bold">LEGUMINOSAS</span></h1>
                    <div class="flexbox padre">
                        <div class="barra-titulo"></div>
                    </div>
                </div>
