...
<meta name="description" content="Centro SEQUOIA es un Centro Pediátrico Exclusivo para el Crecimiento de los niños  Nutricion - Equivalencia en Cereales">
<title>Nutrición - Tablas de equivalencias de cereales con grasa</title>
        ...
        <div class="contenedor-principal" id="contenedor-principal">
            <div class="cuadros-crecimiento">
                <div class="titulos-grid-baja-estatura">
                    ...
                    <h1><span class="font-bold">CEREALES CON GRASA</span></h1>
                    <div class="flexbox padre">
                        <div class="barra-titulo"></div>
                    </div>
                </div>
            ...
            <div class="tamaño-img">
                <img src="/img/tablas/cereales-con-grasa.webp" alt="contacto crecimiento">
            </div>
            <div class="justificar-texto-90 centrar-texto">
                <div>
                    ...
                    <div class="tablas-grid-2">
                        <div class="tablas-letras">
                            ...
                            <p>Tostada 1 1/2 pzas</p>
                            <p>Granola 1/4 tza</p>
                        </div>
                        <div class="linea-vertical-tablas"></div>
                        <div class="tablas-letras">
                            <p>Papas fritas 6 hojuelas</p>
                            <p>Fritura de maiz 2 cdas</p>
                            <p>Crutones 3/4 tza</p>
                        </div>
                    </div>
                </div>
                <div>
                    <div>
                        ...
                        <p class="tablas-letras-titulo">1 PIEZA O 1 REBANADA CON GRASA</p>
                ...
                <div>
                    <div>
                        <div class="linea-horizontal-tablas mt-1"></div>
                        <p class="tablas-letras-titulo">1/3 PIEZA CON GRASA</p>
                        <div class="linea-horizontal-tablas mb-1"></div>
                    </div>
