            ...
            <div class="contenedor-90porciento">
                <div class="justificar-texto-90-listas">
                    ...
                    <ul>
                        ...
                        <li>Malformaciones congénitas (cardiacas, renales, etc.) </li>
            ...
            <div class="contenedor-90porciento">
                <div class="justificar-texto-90-listas">
                    ...
                    <ul>
                        ...
                        <li>Malformaciones uterinas </li>
                        <li>Paridad (nulípara, gran multípara) </li>
                        <li>Intervalo < 6 meses entre embarazos </li>
                        <li>Anteriores fetos PEG </li>
                        <li>Malnutrición </li>
                        <li>Infecciones crónicas </li>
                        <li>Enfermedades crónicas (colagenopatías, insuficiencia renal) </li>
                        <li>Hipertensión crónica o preeclampsia </li>
                        <li>Anemias, neumopatías y cardiopatías cianosantes (hipoxemia) </li>
                    </ul>
                </div>
            </div>
            <div class="contenedor-90porciento">
            ...
            <div class="contenedor-90porciento">
                <div class="justificar-texto-90-listas">
                    ...
                    <ul>
                        ...
                        <li>Fármacos (anticoagulantes, anticonvulsivantes,antineoplásicos) </li>
                        <li>Tabaco </li>
                        <li>Otros tóxicos (alcohol, opioides) </li>
                        <li>Infecciones prenatales (TORCH, varicela,malaria,sífilis,Chagas,listeria,HIV)</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="contenedor-90porciento">
                <div class="justificar-texto-90-listas">
                    <ul>
                        ...
                        <li>Asimétrico: el peso es el más afectado, con preservación relativa del crecimiento del encéfalo, del cráneo y los huesos largos.</li>
                    </ul>
                </div>
            </div>
            <div class="justificar-texto-90 justificar-derecha-texto">
            ...
            <div class="contenedor-90porciento ">
                <div class="justificar-texto-90-listas">
                    <ul>
                        ...
                        <li>Infecciones congénitas en el primer trimestre (p. ej., por citomegalovirus, virus de la rubéola, o Toxoplasma gondii)</li>
                    </ul>
                </div>
            </div>
            <div class="justificar-texto-90 justificar-derecha-texto">
            ...
            <div class="contenedor-90porciento">
                <div class="justificar-texto-90-listas">
                    <ul>
                        ...
                        <li>Insuficiencia placentaria relativa causada por la gestación múltiple</li>
                        <li>Involución placentaria que acompaña a la posmadurez</li>
                        <li>Hipoxemia materna crónica causada por una enfermedad pulmonar o cardíaca</li>
                        <li>Malnutrición materna</li>
                        <li>Concepción utilizando la tecnología de reproducción asistida</li>
                    </ul>
                </div>
            </div>
            <div class="justificar-texto-90 justificar-derecha-texto">
