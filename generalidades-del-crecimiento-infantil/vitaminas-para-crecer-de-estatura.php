    ...
    <div id="site-canvas">
        ...
        <main class="main-container">
            ...
            <div class="tamaño-img ">
                    <img width="1000" height="400"  src="/img/generalidades-del-crecimiento-infantil/alimentos-para-el-crecimiento.webp" alt="Banner doctor información sobre pubertad y adulescencia"></a>
            </div>
            <div class="page">
                <nav>
                    <ul class="breadcrumb__list">
                        ...
                        <li class="breadcrumb__group">
                            <a href="/generalidades-del-crecimiento-infantil/nutricion-malnutricion-y-crecimiento">Nutrición malnutrición y crecimiento</a>
            ...
            <article class="article-container">
                ...
                <p class="centrar-texto"><em>“Revisado médicamente por el <a href="/acerca-de-este-sitio/conoce-a-nuestros-medicos-editores"> equipo médico de Centro Sequoia</a>, México  Publicado el 19 de enero del 2021." (Tiempo de lectura aproximado: 12 minutos)</em></p>
                ...
                <p>La vitamina C o el ácido ascórbico se requieren naturalmente para mejorar el rápido crecimiento y la <a href="/etapas-de-la-ninez/"> madurez del bebé</a>. Los niños deben consumir esta vitamina en particular para el desarrollo corporal para <a href="/generalidades-del-crecimiento-infantil/como-crecer-de-estatura"> aumentar la altura rápidamente</a>. Los cítricos, el plátano y el aguacate son algunos alimentos esenciales que aportan mucha vitamina C para <b>nutrir los huesos</b>, formar nuevos colágenos y revivir la fuerza del cuerpo.</p>
                ...
                <p>Su hijo puede obtener los nutrientes mencionados anteriormente de una variedad de alimentos. Éstos incluyen:</p>
                <ul>
                ...
                <p>El pollo es sin duda una de las comidas favoritas de los niños de todas las edades. También es una de las mejores fuentes para obtener proteínas entre los alimentos de origen animal. Ayuda a desarrollar tejidos y músculos, lo que permite que su hijo crezca más. <b>Aumente la altura con proteínas</b>, ya que ayuda a su pequeño a desarrollar músculo magro y le da mucha energía para seguir con su día. </p>
                <ul>
                    <li>Soya</li>
                </ul>
                <p>Este alimento lleno de nutrientes ayuda a mejorar la salud y la altura de su hijo. Está cargado de carbohidratos, ácido fólico, fibra, proteínas y vitaminas. Las vitaminas y proteínas son esenciales para la altura en los niños en crecimiento. La soja es un excelente sustituto para los vegetarianos que buscan opciones de proteínas. Además, esta proteína a base de plantas también ayuda a mejorar los músculos   entre los niños pequeños. </p>                
                <p>Puede servir soja en ensaladas o tofu elaborado con soja. Los niños disfrutan del tofu recién sacado del refrigerador, horneado e incluso picado y mezclado en ensaladas. Puede servir tofu en sopa de pollo con fideos, como nuggets, en huevos revueltos y rollitos de primavera. La clave para las comidas de los niños es ser creativos y servir algo delicioso que les guste para aumentar sus posibilidades de comérselo todo. </p>
                <p>Si su hijo es intolerante a la lactosa y tiene problemas para digerir la leche de vaca, puede sustituirla por leche de soja fortificada. Contiene calcio, proteínas y vitamina D y puede usarse con batidos y agregarse a cereales. </p>
                <ul>
                    <li>Plátano</li>
                </ul>
                <p>Rico en potasio, manganeso y calcio, el humilde plátano es una fruta simple que realmente puede ayudar a mejorar la salud de su hijo.</p>
                <ul>
                    <li>Nueces y semillas</li>
                </ul>
                <p>Las nueces y las semillas también son excelentes alimentos para darle a su hijo cuando está creciendo. Las nueces y las semillas son ricas en minerales y vitaminas esenciales, así como en grasas saludables y aminoácidos, que son vitales para el crecimiento. Puede agregarlos a los cereales para el desayuno u otras preparaciones para el desayuno o dárselos a su hijo como bocadillo.</p>
                <ul>
                    <li>Verdura de hoja verde</li>
                </ul>
                <p>Su hijo puede hacer una mueca cuando ve verduras verdes, ¡pero usted sabe lo buenas que son para él! Las verduras verdes como el brócoli, las espinacas, los guisantes y las coles de Bruselas también son ricas en minerales esenciales, vitaminas y fibra. Todos estos elementos son imprescindibles para un buen crecimiento y desarrollo en general. Las verduras verdes deben incluirse en su dieta, ¡sin importar cuántas excusas tenga para no comerlas!</p>
                <ul>
                    <li>Frutas</li>
                </ul>
                <p>La ingesta de frutas frescas de temporada también es buena para su hijo. Son tan ricos en vitaminas, minerales y fibra que la dieta de cualquier niño estaría incompleta sin ellos. Por lo tanto, asegúrese de alimentar a su hijo con todo tipo de frutas, especialmente aquellas ricas en vitamina C y A, como papayas, naranjas, sandías, mangos ,  manzanas y albaricoques.</p>
                <ul>
                    <li>Pescado</li>
                </ul>
                ...
                <p>No es ningún secreto que las zanahorias son ricas en vitaminas A y C. Estas vitaminas son esenciales para conservar el calcio en los huesos y mantenerlos sanos.</p>
                <ul>
                    <li>Granos integrales</li>
                </ul>
                <p>Los cereales integrales son muy saludables y esenciales para los niños. Son un almacén de energía, siendo muy ricos en fibra, vitaminas, hierro, magnesio y selenio. ¡El pan y la pasta integrales son excelentes opciones para incluir en la dieta de su hijo para aumentar su estatura!</p>                
                <ul>
                    <li>Carne roja</li>
                </ul>
                <p>La carne roja, que debe administrarse con moderación, es otra opción de comida no vegetariana que es súper rica en proteínas. Sin embargo, dado que demasiada carne roja no es buena para el organismo, su consumo debe ser moderado.</p>
                <ul>
                    <li>Frijoles</li>
                </ul>
                ...
                <div class="author-info">
                    ...
                    <div>
                        <strong>Escrito por la Nutrióloga Clínica Betzabe Salgado Arroyo</strong>
                        <p><a href="/biografias/betzabe-salgado-arroyo"> La nutrióloga Betzabe Salgado Arroyo </a>es licenciada en nutrición clínica, egresada de la Universidad Autónoma Metropolitana (UAM). Ella es especialista en nutrición Clínico-Pediátrica del Hospital Infantil de México Federico Gómez. Adscrita al Departamento de Gastroenterología y Nutrición en el Hospital Infantil de México Federico Gómez y Centro Sequoia. </p>
                    </div>
                </div>
                <h2>Bibliografías</h2>
                <ul>
                    <li> COMER PARA CRECER, Maria Jose Rossello, DEBOLSILLO; 001 edición (12 marzo 2004)</li>
                    <li>Higiene de la Pubertad, Guillermina Mejia Soto,Edamex, Editores Asociados Mexicanos, S. A. de C. V., 2000 - 80 páginas</li>
                    <li>Para la Vida / For Life, UNICEF, UNESCO, UNFPA, Fondo de las naciones unidas para la infancia 2010</li>
                    <li>Estado mundial de la infancia 2019: Niños, alimentos y nutrición - Escrito por UNICEF, 2019</li>
                    <li>Ayúdame a crecer sano, Josep Comellas, Gemma Bes Padros, Amat Editorial, Barcelona 2006</li>
                    <li>La guía para las vitaminas y suplementos / Guide for Vitamins and Supplements, Don Colbert, Casa creación, 2017</li>
                    <li>Alimentos para ayudarte a correr, brillar y crecer,  U.S. Dept. of Agriculture, Food and Nutrition Service (1 Enero 1999)</li>
                    <li>Qué come mi hijo: Comer para crecer. De la lactancia a la adolescencia,  Lucio Tennina, Grijalbo,  (1 Noviembre 2012)</li>
                    <li>La alimentación de nuestros hijos, Montse Bradford, Oceano Ambar </li>
                    <li>Nutrición en Pediatría, Setton. Débora - Panamericana, 2014</li>
                </ul>
            </article>
        </main>
