        ...
        <div class="contendor-crecimiento">
            <div class="cuadros-crecimiento mt-1">
                <div class="titulos-grid-crecimiento-infantil">
                    ...
                    <h1 style="font-size: calc(1.5em + 1vw);"> <span class="font-bold">AVISO DE PRIVACIDAD</h1>
                    <div class="flexbox padre">
                        <div class="barra-titulo"></div>
                    </div>
                </div>
            ...
            <div class="tamaño-img">
                <img src="/img/banners/aviso-de-privacidad.webp" alt="aviso de privacidad de sequoia">
            </div>
