    ...
    <section id="site-canvas">
        ...
        <div class="contenedor-principal" id="contenedor-principal">
            ...
            <div class="contenedor-85porciento ">
                <div class="justificar-texto-90-listas">
                    <ul>
                        ...
                        <li>Medicamentos: el uso de algunos medicamentos puede retardar el crecimiento. El uso crónico de corticosteroides es un posible ejemplo de esto. Sin embargo, las enfermedades crónicas que a menudo requieren corticosteroides, como
                            el asma, también pueden afectar el crecimiento.</li>
                        <li>Enfermedad crónica: las condiciones de salud a largo plazo, como la fibrosis quística, la enfermedad renal y la enfermedad celíaca, pueden provocar una estatura adulta más baja de lo esperado. Los niños que han tenido cáncer también
                            pueden ser más bajos cuando son adultos.</li>
            ...
            <div class="justificar-texto-85 justificar-derecha-texto mt-2 ">
                ...
                <p>En general, los hombres comienzan la pubertad entre los 10 y los 13 años y experimentan un crecimiento acelerado entre los 12 y los 15 años. Esto significa que su mayor crecimiento acelerado ocurre aproximadamente dos años después de que
                    ocurre con las mujeres.</p>
            ...
            <div class="justificar-texto-85 justificar-derecha-texto mt-2 ">
                ...
                <p>Debido a que los patrones de crecimiento están determinados en gran medida por la genética, existen muchas variaciones en lo que respecta a la altura "normal". Las expectativas de crecimiento general basadas en la edad provienen de estudios
                    de poblaciones sanas de niños.</p>
            </div>
            <div class=" pt-15 justificar-texto-90  ">
            ...
            <div class="justificar-texto-85 justificar-derecha-texto mt-2 ">
                <p>La nutrición es importante y una persona desnutrida puede desarrollarse más tarde que sus compañeros. <a href="/generalidades-del-crecimiento-infantil/nutricion-malnutricion-y-crecimiento"> La desnutrición severa en la infancia </a> puede
                    contribuir a retrasos en el crecimiento, que pueden tener efectos continuos si no se corrigen.</p>
                <p>La <a href=""> Organización Mundial de la Salud (WHO)****</a> describe el crecimiento deficiente en los niños según el peso esperado para la altura, la altura para la edad y el peso para la edad. Los niños que sufren de mala nutrición,
                    infecciones repetidas y estimulación psicosocial inadecuada tienen más probabilidades de tener un crecimiento deficiente.</p>
                <p>En 2013, según el Servicio Mundial de Educación sobre el Hambre, más de 200 millones de niños menores de 5 años en todo el mundo sufrían desnutrición significativa o desnutridos, lo que los deja en riesgo de pubertad retrasada, así como
            ...
            <div class="justificar-texto-85 justificar-derecha-texto mt-2 ">
                ...
                <p>A pesar de los datos recopilados para las tablas de crecimiento, las alturas y pesos "normales" son difíciles de definir. El patrón de <b> crecimiento de su hija adolescente </b> está determinado en gran medida por la genética. Los padres
                    más bajos, por ejemplo, tienden a tener hijos más bajos, mientras que los padres más altos tienden a tener hijos más altos.</p>
                <p>Aunque puede preocuparse si su hija no es tan alto como otras compañeras de clase, la pregunta más importante es si su hija continúa creciendo a un ritmo normal. Si su médico detecta un problema, como una <b> tasa de crecimiento </b> que
                    había sido normal pero que se ha estabilizado recientemente, es posible que realice un seguimiento de las medidas de su hijo con cuidado durante varios meses para ver si el patrón de crecimiento sugiere un posible problema de salud
                    o es solo una variación de normal.</p>
                <p>No es inusual que <b> las adolescentes </b> tengan sus propias preocupaciones sobre cómo están creciendo y cómo se ven. Las niñas pueden ser muy críticas con su propio peso, lo que a veces puede generar preocupaciones sobre la imagen corporal
                    y prácticas dietéticas poco saludables. Los niños tienden a estar más preocupados por su altura y desarrollo muscular, lo que también puede llevar a prácticas poco saludables, como el uso de esteroides y suplementos proteicos.</p>
